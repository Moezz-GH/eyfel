<template>
<div class="h-[30rem] md:h-[calc(90vh-106px)]  flex flex-col bg-my-bg-image5 bg-cover bg-center bg-no-repeat"></div>
<div class="max-w-7xl mx-auto px-4 xl:px-0 pb-10">
    <div class="grid lg:grid-cols-7 lg:gap-x-12 xl:gap-x-12 lg:items-center">
        <div class="lg:col-span-3 mt-10 lg:mt-0">
            <img class="w-full rounded-xl" src="../../assets/products/اماكن-تواجد-فروعنا-.png" alt="Hero Image">
        </div>
